...
public class BPlusTreeFileGustavoMachadoDeFreitas extends BPlusTree implements PageSerialization {
     ...
     *
     */
    public BPlusTreeFileGustavoMachadoDeFreitas(int m, int leafM, RowSchema keySchema, RowSchema valueSchema) {
     ...
     * @param valueSchema: the schema of the indexed values.
     */
    public BPlusTreeFileGustavoMachadoDeFreitas(int m, int leafM, PageFile pagefile, RowSchema keySchema, RowSchema valueSchema) throws InstantiationException, IllegalAccessException {
        super(m, leafM, keySchema, valueSchema);
        this.file = pagefile;
