...
public class Test_1 {
    ...
    public void insert4(BPlusTreeFile1 tree, ArrayList<Key> list) {
    ...
    public void delete(BPlusTreeFile tree, Key query) {
    ...
    public void delete4(BPlusTreeFile tree, ArrayList<Key> list) {
...
//            }
    ...
    public void query(BPlusTreeFile tree, Key query) {
    ...
    public void query4(BPlusTreeFile1 tree, ArrayList<Key> list, ArrayList<String> operations) throws Exception {
    ...
    public void deletedQuery4(BPlusTreeFile1 tree, ArrayList<Key> list, ArrayList<String> operations) throws Exception {
...
System.out.println("deleted test OK");
    ...
    public void partialQuery(BPlusTreeFile tree, ArrayList<Key> list) {
        Random r = new Random();
        for (int i = 0; i < list.size(); i++) {
            //level = 1;
    ...
    public void update(BPlusTreeFile tree, Key query, int newChild) {
    ...
    public void testHard(int iterations, BPlusTreeFile1 tree) throws Exception {
...
//        }
    ...
    public void testHard(BPlusTreeFile1 tree) throws Exception {
        Random random = new Random();
        int max = 50;
...
keys.add(key);
    ...
    public void testHard2(BPlusTreeFile1 tree) throws Exception {
        Random random = new Random();
        int max = 3200;
    ...
    public void testHard1(BPlusTreeFile1 tree, ArrayList<String> operations) throws Exception {
        Random random = new Random();
        int max = 50;
    ...
    public static void main(String[] args) {
        try {
            ...
            PersistentPageFile p = new PersistentPageFile(4096, Paths.get("c:\\teste\\mtree\\mtree"), false);
            BPlusTreeFile1 tree = new BPlusTreeFile1(5, 7, p, keyPrototype, valuePrototype);
            //tree.initialize();
