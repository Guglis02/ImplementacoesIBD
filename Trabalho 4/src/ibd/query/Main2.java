...
public class Main2 {
    ...
    public Operation testNestedLoopJoinQuery() throws Exception {
        ...
        Table table1 = createTable("c:\\teste\\ibd", "tab1", Table.DEFULT_PAGE_SIZE, 1000, true, 20, 50);
        Table table2 = createTable("c:\\teste\\ibd", "tab2", Table.DEFULT_PAGE_SIZE, 1000, true, 50, 50);
