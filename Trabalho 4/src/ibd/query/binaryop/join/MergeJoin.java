...
/**
 * Performs a nested loop join between the left and the right operations. This
 * operation performs an equi-join between a left pk and a right pk. The pks
 * used as the join condition comes from the source tuples defined by the
 * specified aliases.
 *
 * @author Sergio
 */
public class MergeJoin extends BinaryOperation {
     ...
     * @throws Exception
     */
    public MergeJoin(Operation leftOperation, Operation rightOperation) throws Exception {
     ...
     *
     * @param leftOperation the left side operation
     * @param leftDataSourceAlias the alias of the data source from the left
     * side used to perform the join condition of this nested lopp join
     * @param rightOperation the right side operation
     * @param rigthtDataSourceAlias the alias of the data source from the right
     * side used to perform oin condition of this nested lopp join
     * @throws Exception
     */
    public MergeJoin(Operation leftOperation, String leftDataSourceAlias, Operation rightOperation, String rigthtDataSourceAlias) throws Exception {
    ...
    public Iterator<Tuple> lookUp(LookupFilter lookup) {
        return new MergeJoinIterator(lookup);
    }
     ...
     */
    private class MergeJoinIterator extends OperationIterator {
         ...
         * be satisfied
         */
        public MergeJoinIterator(LookupFilter lookup) {
            leftTuple = null;
            this.lookup = lookup;
